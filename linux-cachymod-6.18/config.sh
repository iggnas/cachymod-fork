...
scripts/config -d CONFIG_CFG80211_DEFAULT_PS
scripts/config -d CONFIG_PCIE_BUS_DEFAULT -e CONFIG_PCIE_BUS_PERFORMANCE
...
scripts/config -d KPROBES -d SCHED_DEBUG -d SCHEDSTATS -d KALLSYMS_SELFTEST \
            -d KALLSYMS_ALL -d EARLY_PRINTK -d KALLSYMS \
